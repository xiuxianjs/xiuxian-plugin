const mainHelpConfig = [
    ...
    },
    {
        group: '修行之路',
        list: [
            { icon: 'help-icon_13', title: '#我的消息', desc: '仅消息受限机器人可用，查看行为结算后的消息记录' },
            { icon: 'help-icon_13', title: '#清理消息', desc: '仅消息受限机器人可用，清理行为结算消息' },
    ...
    },
    {
        ...
        list: [
            ...
            { icon: 'help-icon_13', title: '#(学习|忘掉)+功法名', desc: '学习或忘掉功法' },
...
export { mainHelpConfig as default };
