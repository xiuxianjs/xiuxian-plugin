        ...
        if (action !== null) {
            ...
            if (action.shutup === '0') {
                ...
                if (now_time > end_time) {
                    ...
                    const time = (typeof rawTime === 'number' ? rawTime : parseInt(rawTime || '0', 10)) / 1000 / 60;
            ...
            if (action.working === '0') {
                ...
                if (now_time > end_time) {
                    ...
                    const time = (typeof rawTime2 === 'number' ? rawTime2 : parseInt(rawTime2 || '0', 10)) / 1000 / 60;
                    let otherLingshi = 0;
                    let other_xueqi = 0;
                    let rand = Math.random();
                    if (rand < 0.2) {
                    ...
                    const get_lingshi = Math.trunc(lingshi * time + otherLingshi);
                    await setFileValue(playerId, get_lingshi, '灵石');
                    if (action.acount === null) {
                        action.acount = 0;
                    }
                    const arr = action;
