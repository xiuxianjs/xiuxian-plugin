...
import { openAU, Read_player, Add_灵石 as Add___, Add_najie_thing } from '../model/xiuxian.js';
...
scheduleJob('0 0/1 * * * ?', async () => {
    {
        ...
        if (wupin.last_offer_price + interMinu * 60 * 1000 > nowTime) {
            ...
            if (last_offer_player === 0) {
                ...
                await Add_najie_thing(last_offer_player, wupin.thing.name, wupin.thing.class, wupin.amount, wupin.thing.pinji);
