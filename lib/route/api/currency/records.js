...
import { getAllRechargeRecords, getRechargeRecordDetail, getUserRechargeRecords } from '../../../model/currency.js';
...
const GET = async (ctx) => {
    try {
        ...
        const rechargeType = ctx.request.query.rechargeType;
...
const GET_DETAIL = async (ctx) => {
    try {
        ...
        const recordId = ctx.request.query.recordId;
        if (recordId) {
