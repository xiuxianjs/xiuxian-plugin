...
const validateLogin = async (username, password) => {
    try {
        ...
        await redis.setex(`${SESSION_PREFIX}${token}`, 86400, JSON.stringify(sessionData));
...
export { createUser, deleteUser, getAllUsers, getUserById, getUserByUsername, initDefaultAdmin, logout, setUserPassword, validateLogin, validateToken };
