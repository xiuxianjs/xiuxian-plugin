...
import { existplayer, Read_qinmidu, Write_qinmidu, find_qinmidu, Read_player } from '../../../../model/xiuxian.js';
import 'dayjs';
import { found, chaoshi } from '../daolv.js';
...
var res = onResponse(selects, async (e) => {
    ...
    let A_action = await getDataByUserId(A, 'action');
