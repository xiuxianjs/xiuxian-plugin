...
import '@alemonjs/db';
import { existplayer, addExp4 } from '../../../../model/xiuxian_impl.js';
...
import { readActionWithSuffix, isActionRunning, formatRemaining, remainingMs, stopActionWithSuffix } from '../../../actionHelper.js';
...
var res = onResponse(selects, async (e) => {
    ...
    for (const item of newtripod) {
        if (user_qq == item.qq) {
            ...
            const v = player.隐藏灵根.控器 / (Math.abs(max[1] - player.隐藏灵根.type) + 5);
