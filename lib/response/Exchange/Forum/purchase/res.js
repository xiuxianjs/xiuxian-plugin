...
const executePurchaseWithLock = async (e, userId, orderId, requestedQty, isLegacyIndex) => {
...
const executePurchaseWithLockWrapper = async (e, userId, orderId, requestedQty, isLegacyIndex) => {
