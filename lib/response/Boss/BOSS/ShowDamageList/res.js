...
import { KEY_RECORD, KEY_WORLD_BOOS_STATUS } from '../../../../model/constants.js';
import '@alemonjs/db';
...
var res = onResponse(selects, async (e) => {
    ...
    const PlayerRecord = parseJson(await redis.get(KEY_RECORD));
    const WorldBossStatusStr = parseJson(await redis.get(KEY_WORLD_BOOS_STATUS));
