...
import { isBossWord2, WorldBossBattleInfo, bossStatus, WorldBossBattle } from '../../../../model/boss.js';
import 'svg-captcha';
import 'sharp';
import 'lodash-es';
...
const isLevelLimit = (levelId, lunhui) => {
...
const executeBossBattleWithLock = (e, userId, player, boss) => {
    const lockKey = keysLock.boss('boss2');
    return withLock(lockKey, async () => {
        await WorldBossBattle(e, userId, player, boss, '2');
    }, BOSS_LOCK_CONFIG);
};
