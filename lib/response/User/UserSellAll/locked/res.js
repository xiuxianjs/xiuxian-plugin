...
import '@alemonjs/db';
import { existplayer, readNajie, foundthing, updateBagThing } from '../../../../model/xiuxian.js';
import 'dayjs';
...
var res = onResponse(selects, async (e) => {
    ...
    let ifexist;
    if (un_lock == '锁定') {
        ifexist = await updateBagThing(usr_qq, thing_name, thing_exist.class, thing_pinji, 1);
        if (ifexist) {
        ...
        ifexist = await updateBagThing(usr_qq, thing_name, thing_exist.class, thing_pinji, 0);
        if (ifexist) {
