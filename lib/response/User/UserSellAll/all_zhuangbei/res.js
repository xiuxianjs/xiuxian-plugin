...
function calcBaseThree(player) {
    const levelObj = data.Level_list.find((i) => i?.['level_id'] === player['level_id']);
    const phyObj = data.LevelMax_list.find((i) => i?.['level_id'] === player['Physique_id']);
