...
import 'path';
import { existplayer, get_player_img, __PATH, get_random_talent, Write_player, Write_equipment, Write_najie, Add_HP, Write_danyao } from '../../../../model/xiuxian.js';
...
var res = onResponse(selects, async (e) => {
    ...
    let new_player = {
        ...
        名号: `路人甲${n}号`,
        宣言: '这个人很懒还没有写',
        avatar: (await e.UserAvatar?.toURL()) ||
