...
import { existplayer, Go, isNotNull, get_random_fromARR, get_random_talent, Write_equipment, Write_najie, Add_HP, Write_danyao } from '../../../../model/xiuxian.js';
import 'dayjs';
            ...
            if (isNotNull(player.宗门)) {
                if (player.宗门.职位 != '宗主') {
                    ...
                    if (ass.所有成员.length < 2) {
                        ...
                        let randmember = data.getData('player', randmember_qq);
