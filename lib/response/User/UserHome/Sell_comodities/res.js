...
import { existplayer, readNajie, foundthing, convert2integer, existNajieThing, addNajieThing, Add_灵石 as Add___ } from '../../../../model/xiuxian.js';
import 'dayjs';
...
var res = onResponse(selects, async (e) => {
    ...
    await addNajieThing(usr_qq, thing_name, thing_exist.class, -thing_amount, thing_piji);
