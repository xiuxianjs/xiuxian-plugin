...
import 'path';
import { existplayer, isNotNull, Write_player, Read_equipment, player_efficiency, get_random_fromARR, Add_najie_thing, Write_equipment, Add_HP } from '../../../../model/xiuxian.js';
        ...
        if (ass.power != 0) {
            ...
            if (player.宗门.职位 != '宗主') {
                ...
                if (ass.所有成员.length < 2) {
                    ...
                    data.setData('player', usr_qq, player);
                    data.setAssociation(ass.宗门名称, ass);
                    Send(Text(`轮回前,遵循你的嘱托,${randmember.名号}将继承你的衣钵,成为新一任的宗主`));
                }
            }
        }
    }
