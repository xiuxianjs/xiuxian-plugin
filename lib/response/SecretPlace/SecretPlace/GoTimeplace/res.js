...
import { Go, readPlayer, sleep, isNotNull, Add_灵石 as Add___, existNajieThing, addNajieThing, Add_修为 as Add___$1 } from '../../../../model/xiuxian.js';
import 'dayjs';
...
var res = onResponse(selects, async (e) => {
    ...
    let dazhe = 1;
    if ((await existNajieThing(usr_qq, '仙府通行证', '道具')) &&
        player.魔道值 < 1 &&
