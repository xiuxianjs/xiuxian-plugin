...
import { Go, Read_player, isNotNull, exist_najie_thing, Add_najie_thing, Add_灵石 as Add___ } from '../../../../model/xiuxian.js';
import 'dayjs';
...
var res = onResponse(selects, async (e) => {
    ...
    else if ((await exist_najie_thing(usr_qq, '仙境优惠券', '道具')) &&
        player.魔道值 < 1 &&
        (player.灵根.type == '转生' || player.level_id > 41)) {
        dazhe = 0.5;
