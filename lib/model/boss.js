...
async function InitWorldBoss() {
    ...
    const health = Math.trunc(x * 150 * playerQuantity * 3);
...
const WorldBossBattle = async (e, { userId, player, boss, key, endLingshi, averageLingshi }) => {
