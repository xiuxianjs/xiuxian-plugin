...
async function settripod(qq) {
    const tripod1 = await readTripod();
...
async function readThat(thingName, weizhi) {
...
function getxuanze(shuju, linggentype) {
    let i;
...
export { getxuanze, jiaozheng, looktripod, mainyuansu, readAll, readIt, readItTyped, readMytripod, readThat, readTripod, restraint, settripod, writeDuanlu };
