...
import ____$q from '../resources/data/item/技能列表.json.js';
...
const DATA_LIST = {
    ...
    Bless: ____$c,
    GuildSecrets: ____$d,
    ForbiddenArea: ____$e,
    FairyRealm: ____$f,
    TimePlace: ____$g,
    TimeGongfa: ____$h,
    TimeEquipment: ____$i,
    TimeDanyao: ____$j,
    Occupation: ____$k,
    experience,
    Danfang: ____$l,
...
var DataList = new DataListx();

export { DATA_LIST, DataListx, DataList as default, getDataList, setDataList };
