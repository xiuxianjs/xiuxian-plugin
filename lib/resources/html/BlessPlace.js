...
const SecretPlace = ({ didian_list }) => {
    return (React.createElement(HTML, null,
        React.createElement(BackgroundImage, { className: 'relative w-full min-h-screen bg-gradient-to-b from-black/30 via-black/20 to-black/40', src: fileUrl },
            ...
            React.createElement("main", { className: 'relative max-w-5xl mx-auto space-y-8 py-8 min-h-screen' },
