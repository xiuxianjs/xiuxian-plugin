...
const MARKDOWN_RENDERERS = {
    ...
    'MD.image': md => {
        ...
        return React.createElement("img", { style: { width: `${w}px`, height: `${h}px` }, className: 'max-w-[15rem] xl:max-w-[20rem] rounded-md', src: url, alt: 'image' });
    },
...
const renderImage = (item) => {
    try {
        ...
        return React.createElement("img", { className: 'max-w-[15rem] xl:max-w-[20rem] rounded-md', src: url, alt: 'Image' });
    }
    catch (e) {
...
const renderImageURL = (item) => {
    try {
        ...
        return React.createElement("img", { className: 'max-w-[15rem] xl:max-w-[20rem] rounded-md', src: raw, alt: 'ImageURL' });
    }
    catch (e) {
...
const renderText = (item) => {
    try {
        ...
        const content = parts.length > 1 ? (React.createElement("span", null, parts.map((line, i) => (React.createElement("span", { key: i },
            line,
