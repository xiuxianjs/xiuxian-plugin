...
const Tuzhi = ({ tuzhi_list }) => {
    ...
    return (React.createElement(HTML, { className: " bg-cover bg-center flex flex-col items-center justify-center p-4 font-serif relative overflow-hidden", style: {
        ...
        React.createElement("div", { className: "relative z-10 w-full max-w-4xl flex flex-col items-center px-5 mb-8" },
            React.createElement("div", { className: "relative w-full" },
                ...
                React.createElement("div", { className: "border-2 border-gradient-to-r from-blue-400/60 to-blue-600/60 rounded-2xl w-full flex flex-col justify-center bg-gradient-to-br from-white/80 via-white/60 to-white/40 backdrop-blur-xl shadow-2xl py-8 relative overflow-hidden" },
        ...
        React.createElement("div", { className: "relative z-10 w-full max-w-5xl flex flex-col items-center px-5 gap-6" }, tuzhi_list?.map((item, index) => (React.createElement("div", { key: index, className: "relative backdrop-blur-xl shadow-xl border-2 p-6 rounded-2xl border-blue-400/40 bg-gradient-to-r from-white/80 to-white/60 shadow-blue-500/20" },
