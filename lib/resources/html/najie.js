...
import fileUrl from '../styles/najie.scss.js';
import fileUrl$3 from '../font/tttgbnumber.ttf.js';
import fileUrl$1 from '../img/player.jpg.js';
import fileUrl$2 from '../img/player_footer.png.js';
    ...
    return (React.createElement("html", null,
        React.createElement("head", null,
          ...
          body {
            ...
            margin: 0;
            text-align: center;
            background-image: url('${fileUrl$1}'), url('${fileUrl$2}');
