...
const Danyao = ({ danyao_have: danyaoHave = [], danyao2_have: danyao2Have = [], danyao_need: danyaoNeed = [] }) => {
    ...
    return (React.createElement(HTML, { className: 'w-full text-center p-4 md:p-8 bg-top  min-h-screen' },
        React.createElement(BackgroundImage, { src: [fileUrl, fileUrl], className: ' w-full text-center p-4 md:p-8 bg-top  min-h-screen relative overflow-hidden' },
            ...
            React.createElement("main", { className: 'relative max-w-5xl mx-auto space-y-12 z-10' },
                (danyaoHave.length > 0 || danyao2Have.length > 0) && (React.createElement("section", { className: 'relative' },
                    ...
                    React.createElement("div", { className: 'relative rounded-3xl bg-white/8 backdrop-blur-xl ring-2 ring-emerald-400/30 p-6 md:p-8 shadow-2xl space-y-6 border border-emerald-300/20' },
                        React.createElement("div", { className: 'flex items-center justify-center space-x-3 mb-6' },
                            ...
                            React.createElement("div", { className: 'w-8 h-8 bg-emerald-400/30 rounded-full flex items-center justify-center' },
                                React.createElement("span", { className: 'text-emerald-300 text-lg' }, "\uD83D\uDC8A"))),
                        React.createElement("div", { className: 'grid gap-6 sm:grid-cols-2 lg:grid-cols-3' }, [...danyaoHave, ...danyao2Have].map((item, index) => (React.createElement("article", { key: index, className: 'relative rounded-2xl bg-gradient-to-br from-emerald-900/40 to-emerald-700/30 p-5 shadow-xl border border-emerald-400/30 backdrop-blur-md' },
                ...
                danyaoNeed.length > 0 && (React.createElement("section", { className: 'relative' },
                    ...
                    React.createElement("div", { className: 'relative rounded-3xl bg-white/8 backdrop-blur-xl ring-2 ring-red-400/30 p-6 md:p-8 shadow-2xl space-y-6 border border-red-300/20' },
                        React.createElement("div", { className: 'flex items-center justify-center space-x-3 mb-6' },
                            ...
                            React.createElement("div", { className: 'w-8 h-8 bg-red-400/30 rounded-full flex items-center justify-center' },
                                React.createElement("span", { className: 'text-red-300 text-lg' }, "\u274C"))),
                        React.createElement("div", { className: 'grid gap-6 sm:grid-cols-2 lg:grid-cols-3' }, danyaoNeed.map((item, index) => (React.createElement("article", { key: index, className: 'relative rounded-2xl bg-gradient-to-br from-red-900/40 to-red-700/30 p-5 shadow-xl border border-red-400/30 backdrop-blur-md' },
