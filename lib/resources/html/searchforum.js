...
const SearchForum = ({ Forum, nowtime }) => {
    return (React.createElement(HTML, { className: "min-h-screen bg-gradient-to-b from-blue-100 to-blue-300 flex flex-col items-center py-8", style: {
        ...
        React.createElement("div", { className: "w-full max-w-2xl mx-auto" },
            ...
            React.createElement("div", { className: "space-y-6" }, Forum &&
                Forum.map((item, index) => (React.createElement("div", { key: index, className: "rounded-xl shadow bg-white/70 p-4 flex flex-col items-start" },
