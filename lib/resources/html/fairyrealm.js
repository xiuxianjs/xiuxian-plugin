    ...
    return (React.createElement(HTML, { className: " w-full text-center p-4 md:p-8 bg-top bg-cover", style: { backgroundImage: `url(${fileUrl})` } },
        React.createElement("main", { className: "max-w-5xl mx-auto space-y-8" },
            React.createElement("header", { className: "space-y-4 flex flex-col items-center" },
                React.createElement("h1", { className: "inline-block px-8 py-2 rounded-2xl bg-black/40 backdrop-blur text-2xl md:text-3xl font-bold tracking-widest  shadow" }, "\u4ED9\u5883"),
                React.createElement("span", { className: "/70 text-sm md:text-base" }, "\u6307\u4EE4\uFF1A#\u9547\u5B88\u4ED9\u5883+\u4ED9\u5883\u540D")),
                ...
                React.createElement("div", { className: "relative z-10 p-4 md:p-5 flex flex-col h-full justify-between" },
                    ...
                    React.createElement("div", { className: "mt-4 space-y-2 text-sm md:text-base /90 font-medium text-left" },
                        ...
                        React.createElement("div", null,
                            ...
                            React.createElement("ul", { className: "pl-4 space-y-1" }, item.three?.map((thing, thingIndex) => (React.createElement("li", { key: thingIndex, className: "/80" }, thing.name)))))))))) || React.createElement("p", { className: "col-span-full /60" }, "\u6682\u65E0\u4ED9\u5883")))));
};
