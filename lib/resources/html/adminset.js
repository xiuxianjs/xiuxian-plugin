...
const SettingItem = ({ label, value, unit = '' }) => (React.createElement("div", { className: "flex items-center justify-between gap-4 px-4 py-2 rounded-lg bg-white/10 backdrop-blur-sm text-white text-sm md:text-base shadow-inner" },
    ...
    return (React.createElement(HTML, { className: "min-h-screen w-full bg-cover bg-fixed bg-top text-center p-4 md:p-8 space-y-8", style: { backgroundImage: `url(${fileUrl})` } },
        React.createElement("main", { className: "max-w-6xl mx-auto space-y-8" },
            React.createElement("header", { className: "text-center space-y-4" },
                ...
                React.createElement("h1", { className: "inline-block px-6 py-2 rounded-2xl bg-black/40 backdrop-blur text-2xl md:text-3xl font-bold tracking-widest text-white shadow" }, "#\u4FEE\u4ED9\u8BBE\u7F6E")),
