...
const XiuxianSettings = props => {
    ...
    return (React.createElement(HTML, { className: "min-h-screen w-full bg-cover bg-fixed bg-center text-center p-4 md:p-8 space-y-8", style: { backgroundImage: `url(${fileUrl})` } },
