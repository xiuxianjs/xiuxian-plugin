                        ...
                        React.createElement("div", { className: "relative backdrop-blur-sm bg-black/40 rounded-3xl border border-red-400/30 p-8 shadow-xl" },
                            React.createElement("div", { className: "text-center mb-8" },
                                React.createElement("div", { className: "flex items-center justify-center gap-4 mb-4" },
                                    React.createElement("div", { className: "w-12 h-12 bg-gradient-to-br from-red-400 to-orange-600 rounded-xl flex items-center justify-center border border-red-300/50 shadow-lg" },
                                        React.createElement("span", { className: "text-2xl" }, "\u26A0\uFE0F")),
                                    React.createElement("h2", { className: "text-2xl font-bold text-red-300" }, "\u7981\u5730")),
                                React.createElement("div", { className: "text-sm text-gray-300" }, "\u5371\u9669\u4E0E\u673A\u9047\u5E76\u5B58\uFF0C\u5F3A\u8005\u65B9\u53EF\u8FDB\u5165")),
