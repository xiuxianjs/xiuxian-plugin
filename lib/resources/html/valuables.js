...
const FloorSection = ({ name, type, icon, color, borderColor }) => (React.createElement("div", { className: 'relative group' },
    React.createElement("div", { className: classNames('absolute inset-0 bg-gradient-to-r rounded-2xl blur-sm', `${color.replace('400', '500')}/20`) }),
    React.createElement("div", { className: classNames('relative backdrop-blur-md bg-white/5 rounded-2xl border p-6 hover:border-opacity-60 transition-all duration-300', borderColor) },
        React.createElement("div", { className: 'flex flex-col items-center gap-4' },
            React.createElement("div", { className: classNames('w-16 h-16 bg-gradient-to-br rounded-xl flex items-center justify-center border border-white/20', color) },
