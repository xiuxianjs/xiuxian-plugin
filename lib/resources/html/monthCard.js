...
const Monthcard = ({ isMonth, avatar }) => {
        ...
        React.createElement("div", { className: 'm-3 mx-auto flex flex-nowrap rounded-3xl z-999 bg-gradient-to-br from-white/60 via-blue-50/50 to-cyan-50/55 backdrop-blur-sm border border-blue-200/30 shadow-xl w-[780px] pb-4' },
            React.createElement("div", { className: 'm-4 w-[780px]' },
                ...
                React.createElement("div", { className: 'space-y-4' },
                    ...
                    React.createElement("div", { className: 'grid grid-cols-1 md:grid-cols-2 gap-4' }, features.map((feature, index) => (React.createElement("div", { key: index, className: 'bg-gradient-to-br from-white/80 via-blue-50/70 to-cyan-50/75 backdrop-blur-xl rounded-xl p-4 border border-blue-200/40 shadow-xl relative overflow-hidden hover:shadow-2xl transition-all duration-300' },
