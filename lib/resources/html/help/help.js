...
import fileUrl from './tw.css.js';
import fileUrl$1 from './help.scss.js';
...
const Help = ({ helpData = [], page = 1, pageSize, total }) => {
    return (React.createElement("html", null,
        ...
        React.createElement("body", { className: "elem-default default-mode text-[18px] text-brand font-sans min-h-screen", style: {
