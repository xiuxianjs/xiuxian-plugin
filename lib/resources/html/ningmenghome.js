...
const Ningmenghome = ({ commodities_list }) => {
    return (React.createElement(HTML, null,
        React.createElement("div", { className: "min-h-screen w-full flex flex-col items-center justify-start p-6 md:p-12 bg-center bg-cover relative", style: {
