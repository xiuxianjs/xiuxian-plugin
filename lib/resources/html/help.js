...
const Help = ({ helpData = [], page = 1, pageSize, total }) => {
    return (React.createElement(HTML, { linkStyleSheets: [fileUrl] },
        React.createElement(BackgroundImage, { className: 'bg-[length:100%_100%] bg-center  elem-default default-mode text-[18px] text-brand font-sans ', src: [fileUrl$1] },
                            ...
                            React.createElement("div", { className: 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4' }, val.list?.map((item, itemIndex) => (React.createElement("div", { key: itemIndex, className: 'relative p-4 rounded-xl bg-gradient-to-br from-black/20 to-black/30 border border-white/10' },
                                ...
                                React.createElement("div", { className: 'relative flex items-start gap-3' },
                                    ...
                                    React.createElement("div", { className: 'flex-1 min-w-0' },
                                        React.createElement("strong", { className: 'block font-bold text-slate-800 mb-1' }, item.title),
                                        React.createElement("span", { className: 'block text-sm leading-relaxed text-gray-600' }, item.desc))))))))))))),
