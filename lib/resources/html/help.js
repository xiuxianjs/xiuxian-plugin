                    ...
                    React.createElement("div", { className: "relative rounded-2xl p-6 bg-gradient-to-br from-black/30 to-black/50 backdrop-blur-xl border border-white/20 shadow-xl" },
                        ...
                        React.createElement("div", { className: "text-center" },
                            ...
                            React.createElement("div", { className: "mt-6" },
                                React.createElement("div", { className: "inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-red-600/30 to-red-700/30 border border-red-400/20 shadow-lg" },
                                    React.createElement("span", { className: "text-red-200/90 text-sm md:text-base font-medium" }, "\u7FFB\u9875\uFF1A"),
                                    React.createElement("code", { className: "px-3 py-1 rounded-lg bg-red-700/50 text-red-100 text-sm md:text-base font-mono shadow-inner border border-red-400/20" }, "\u6307\u4EE4\u540E\u76F4\u63A5\u52A0\u9875\u7801"))))))))));
};
