...
import fileUrl$2 from '../../font/华文中宋x.ttf.js';
import fileUrl$3 from '../../font/tttgbnumber.ttf.js';
import fileUrl$4 from '../../font/NZBZ.ttf.js';
import fileUrl$5 from '../../font/HYWH-85W.ttf.js';
import fileUrl$6 from '../../font/HYWH-65W.ttf.js';
import fileUrl$7 from '../../img/help/shituhelp.jpg.js';
import fileUrl$8 from '../../img/help/icon.png.js';
        ...
        React.createElement("head", null,
          ...
          * {
          ...
          body {
            transform: scale(1);
            width: 100%;
            background: url('${fileUrl$7}') top left no-repeat;
          ...
          .help-icon {
            ...
            display: block;
            position: absolute;
            background: url('${fileUrl$8}') 0 0 no-repeat;
