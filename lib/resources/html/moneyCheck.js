...
const MoneyCheck = ({ user_qq, victory, victory_num, defeated, defeated_num }) => {
    return (React.createElement(HTML, { className: "min-h-screen w-full flex items-center justify-center p-6 md:p-12 relative bg-center bg-cover", style: { backgroundImage: `url(${fileUrl})` } },
