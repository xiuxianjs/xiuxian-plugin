                ...
                React.createElement("div", { className: "w-full max-w-xl mx-auto" },
                    React.createElement("div", { className: "rounded-xl shadow-lg bg-white p-6 mb-6 flex flex-col items-center" },
                        ...
                        React.createElement("div", { className: "flex flex-row" },
                            ...
                            React.createElement("div", { className: "grid grid-cols-9 grid-rows-9 gap-1" }, sudokuData &&
                                sudokuData.map((row, rowIndex) => row.map((cell, colIndex) => (React.createElement("div", { key: `${rowIndex}-${colIndex}`, className: "w-12 h-12 flex items-center justify-center border border-gray-300 text-xl font-semibold bg-gray-50" }, cell !== 0 ? cell : ''))))))))))));
};
