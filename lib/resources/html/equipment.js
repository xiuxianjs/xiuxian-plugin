...
const EquipmentCard = ({ title, equipment, renderStats }) => {
    ...
    return (React.createElement("article", { className: "group relative" },
        React.createElement("div", { className: `absolute inset-0 rounded-2xl bg-gradient-to-r ${quality.gradient} p-[2px] animate-pulse` },
        ...
        React.createElement("div", { className: `relative rounded-2xl p-6 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl 
        ...
        ${quality.glow} hover:shadow-lg` },
            ...
            React.createElement("div", { className: "flex items-center justify-between mb-4" },
                ...
                React.createElement("div", { className: `w-12 h-12 rounded-full bg-gradient-to-r ${quality.gradient} flex items-center justify-center shadow-lg` },
            ...
            React.createElement("div", { className: "mb-4 p-3 rounded-xl bg-gradient-to-r from-white/5 to-white/10 border border-white/10" },
                React.createElement("div", { className: "flex items-center justify-between" },
                    ...
                    React.createElement("span", { className: `px-3 py-1 rounded-full bg-gradient-to-r ${quality.gradient} text-black font-black text-sm shadow-inner border border-white/30` }, quality.name))),
