            ...
            <div>
              {result === 'A' && (
                <div className='inline-flex items-center px-6 py-2 bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-sm border border-green-400/30 rounded-full'>
                  ...
                  <span className='text-green-300 font-semibold'>{playerA.name} 获胜！</span>
                </div>
              )}
              {result === 'B' && (
                <div className='inline-flex items-center px-6 py-2 bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-sm border border-green-400/30 rounded-full'>
                  <span className='text-green-400 text-lg mr-2'>🏆</span>
                  <span className='text-green-300 font-semibold'>{playerB.name} 获胜！</span>
                </div>
              )}
              {result === 'draw' && (
                <div className='inline-flex items-center px-6 py-2 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 backdrop-blur-sm border border-yellow-400/30 rounded-full'>
                  ...
                  <span className='text-yellow-300 font-semibold'>势均力敌，平局！</span>
                </div>
              )}
            </div>
          </div>
            ...
            <div className='relative z-10'>
              <div className='flex gap-4 mb-6'>
                ...
                <div className='flex-1 bg-gradient-to-br from-blue-900/60 to-cyan-800/40 backdrop-blur-sm border border-blue-400/30 rounded-xl p-6 shadow-lg relative overflow-hidden'>
                  ...
                  <div className='flex flex-col items-center'>
                    ...
                    {/* 玩家信息 */}
                    <h3 className='text-lg font-semibold text-blue-200 mb-2'>{playerA.name}</h3>
                    ...
                    <div className='bg-slate-800/50 rounded-lg p-3 border border-blue-400/20 w-full mb-3'>
                      <div className='flex items-center justify-between'>
                        ...
                        <span className='text-amber-300 font-bold text-lg'>{playerA.power}</span>
                      </div>
                    </div>
                ...
                <div className='flex-1 bg-gradient-to-br from-red-900/60 to-pink-800/40 backdrop-blur-sm border border-red-400/30 rounded-xl p-6 shadow-lg relative overflow-hidden'>
                  ...
                  <div className='flex flex-col items-center'>
                    ...
                    {/* 玩家信息 */}
                    <h3 className='text-lg font-semibold text-red-200 mb-2'>{playerB.name}</h3>
                    ...
                    <div className='bg-slate-800/50 rounded-lg p-3 border border-red-400/20 w-full mb-3'>
                      <div className='flex items-center justify-between'>
                        ...
                        <span className='text-amber-300 font-bold text-lg'>{playerB.power}</span>
                      </div>
                    </div>
              ...
              <div className='bg-gradient-to-br from-slate-700/80 to-slate-800/80 backdrop-blur-sm border border-slate-500/30 rounded-xl p-6 shadow-lg'>
                <div className='flex items-center justify-center mb-6'>
                  ...
                  <h3 className='text-xl font-semibold text-slate-200'>战斗过程</h3>
                </div>
                  ...
                  {msg.map((item, index) => (
                    ...
                    >
                      ...
                      <div className='flex items-start'>
                        ...
                        <p className='text-slate-200 text-sm leading-relaxed flex-1'>{item}</p>
                      </div>
                    </div>
                  ))}
                </div>
