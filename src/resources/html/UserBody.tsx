                ...
                <div className='grid grid-cols-3 gap-3'>
                  {gongfa.map((gongfaInfo, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className={`bg-gradient-to-r ${colorConfig.from} ${colorConfig.via} ${colorConfig.to} ${colorConfig.text} rounded-lg shadow-lg font-bold border ${colorConfig.border} text-sm tracking-wide relative overflow-hidden p-2 hover:scale-105 transition-transform duration-200`}
                      >
