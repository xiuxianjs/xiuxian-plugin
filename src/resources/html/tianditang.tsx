    ...
    <HTML>
      <div className='min-h-screen bg-gradient-to-br from-slate-900 via-orange-900 to-slate-900 relative overflow-hidden'>
        ...
        <div className='absolute inset-0 opacity-10'>
          <div className='absolute top-10 left-10 w-32 h-32 border border-orange-400 rounded-full' />
          <div className='absolute top-32 right-20 w-24 h-24 border border-yellow-400 rounded-full' />
          <div className='absolute bottom-20 left-1/4 w-16 h-16 border border-red-400 rounded-full' />
        ...
        <div className='relative z-10 container mx-auto px-4 py-8'>
          ...
          <div className='text-center mb-8'>
            <div className='inline-block relative'>
              <div className='absolute inset-0 bg-gradient-to-r from-orange-600 to-yellow-600 rounded-2xl blur-lg opacity-50' />
          ...
          <div className='max-w-6xl mx-auto'>
            <div className='relative'>
              <div className='absolute inset-0 bg-gradient-to-r from-orange-500/20 to-yellow-500/20 rounded-3xl blur-xl' />
                ...
                <div className='grid grid-cols-2 gap-6'>
                  {commodities_list?.map((item, index) => (
                    <div key={index} className='relative group'>
                      <div className='absolute inset-0 bg-gradient-to-br from-orange-400/20 to-yellow-600/20 rounded-2xl blur-sm' />
