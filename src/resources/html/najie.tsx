                ...
                <div className='flex flex-col md:flex-row items-center gap-6'>
                  ...
                  <div className='flex flex-col items-center'>
                    ...
                    <div className='mt-3 text-center'>
                      <div className='text-lg font-bold text-gray-700'>{user_id}</div>
                  ...
                  <div className='flex-1 space-y-4'>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                      ...
                      <div className='bg-white/20 backdrop-blur-lg rounded-xl p-4 border border-white/30 shadow-lg'>
                        ...
                        <div className='text-lg font-bold text-gray-800'>{najie.等级 || 0}</div>
                      </div>
                      ...
                      <div className='bg-white/20 backdrop-blur-lg rounded-xl p-4 border border-white/30 shadow-lg'>
                        <div className='flex items-center gap-2 mb-2'>
                          ...
                          <span className='text-sm font-medium text-gray-700'>生命值</span>
                        </div>
                      ...
                      <div className='bg-white/20 backdrop-blur-lg rounded-xl p-4 border border-white/30 shadow-lg'>
                        <div className='flex items-center gap-2 mb-2'>
                          ...
                          <span className='text-sm font-medium text-gray-700'>灵石储量</span>
                        </div>
                        <div className='space-y-2'>
                          <div className='flex items-center gap-2'>
                            <div className='flex-1 bg-white/30 backdrop-blur-sm rounded-full h-3'>
              ...
              <div className='relative'>
                ...
                <div className='relative backdrop-blur-xl bg-white/25 rounded-3xl border border-white/40 p-6 shadow-2xl'>
                  <div className='flex items-center gap-3 mb-6'>
                    ...
                    <h2 className='text-2xl font-bold text-gray-700'>【道具】</h2>
                  </div>
                      ...
                      >
                        ...
                        <div className='space-y-2 text-sm'>
                          ...
                          <div className='flex items-center gap-2'>
                            ...
                            <span className='font-bold text-gray-800'>{item.数量}</span>
                          </div>
                          <div className='flex items-center gap-2'>
                            <span className='text-gray-600'>出售价：</span>
                            <span className='font-bold text-gray-800'>{item.出售价}灵石</span>
                          </div>
                          <div className='flex items-center gap-2'>
                            <span className='text-gray-600'>代号：</span>
                            <span className='font-bold text-gray-800'>{index + 101}</span>
                          </div>
                        </div>
                      </div>
                    ))}
              ...
              <div className='relative'>
                ...
                <div className='relative backdrop-blur-xl bg-white/25 rounded-3xl border border-white/40 p-6 shadow-2xl'>
                  <div className='flex items-center gap-3 mb-6'>
                    ...
                    <h2 className='text-2xl font-bold text-gray-700'>【装备】</h2>
                  </div>
                  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                          ...
                          <div className='space-y-2 text-sm'>
                            <div className='grid grid-cols-2 gap-2'>
                              <div className='flex items-center gap-1'>
                                ...
                                <span className='font-bold text-gray-800'>{stats.attribute}</span>
                              </div>
                              <div className='flex items-center gap-1'>
                                <span className='text-gray-600'>攻击:</span>
                                <span className='font-bold text-gray-800'>{stats.atk}</span>
                              </div>
                              <div className='flex items-center gap-1'>
                                <span className='text-gray-600'>防御:</span>
                                <span className='font-bold text-gray-800'>{stats.def}</span>
                              </div>
                              <div className='flex items-center gap-1'>
                                <span className='text-gray-600'>血量:</span>
                                <span className='font-bold text-gray-800'>{stats.HP}</span>
                              </div>
                            </div>
                            <div className='flex items-center gap-1'>
              ...
              <div className='relative'>
                ...
                <div className='relative backdrop-blur-xl bg-white/25 rounded-3xl border border-white/40 p-6 shadow-2xl'>
                  <div className='flex items-center gap-3 mb-6'>
                    ...
                    <h2 className='text-2xl font-bold text-gray-700'>【丹药】</h2>
                  </div>
                  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                        ...
                        <div className='space-y-2 text-sm'>
                          {item.HPp > 0 && (
                            <div className='flex items-center gap-1'>
                              ...
                              <span className='font-bold text-gray-800'>{item.HPp * 100}%</span>
                            </div>
                          )}
                          {item.exp > 0 && (
                            <div className='flex items-center gap-1'>
                              <span className='text-gray-600'>增加修为:</span>
                              <span className='font-bold text-gray-800'>{item.exp}</span>
                            </div>
                          )}
                          {item.xingyun > 0 && (
                            <div className='flex items-center gap-1'>
                          ...
                          <div className='flex items-center gap-2'>
                            <span className='text-gray-600'>代号：</span>
                            <span className='font-bold text-gray-800'>{index + 201}</span>
                          </div>
                        </div>
                      </div>
                    ))}
              ...
              <div className='relative'>
                ...
                <div className='relative backdrop-blur-xl bg-white/25 rounded-3xl border border-white/40 p-6 shadow-2xl'>
                  <div className='flex items-center gap-3 mb-6'>
                    ...
                    <h2 className='text-2xl font-bold text-gray-700'>【草药】</h2>
                  </div>
                  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                    {najie.草药.map((item, index) => (
                      ...
                      >
                        ...
                        <div className='space-y-2 text-sm'>
                          ...
                          <div className='flex items-center gap-2'>
                            <span className='text-gray-600'>代号：</span>
                            <span className='font-bold text-gray-800'>{index + 301}</span>
                          </div>
                        </div>
                      </div>
                    ))}
              ...
              <div className='relative'>
                ...
                <div className='relative backdrop-blur-xl bg-white/25 rounded-3xl border border-white/40 p-6 shadow-2xl'>
                  <div className='flex items-center gap-3 mb-6'>
                    ...
                    <h2 className='text-2xl font-bold text-gray-700'>【材料】</h2>
                  </div>
                  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                      ...
                      >
                        ...
                        <div className='space-y-2 text-sm'>
                          ...
                          <div className='flex items-center gap-2'>
                            ...
                            <span className='font-bold text-gray-800'>{item.品级}</span>
                          </div>
                        </div>
                      </div>
                    ))}
              ...
              <div className='relative'>
                ...
                <div className='relative backdrop-blur-xl bg-white/25 rounded-3xl border border-white/40 p-6 shadow-2xl'>
                  <div className='flex items-center gap-3 mb-6'>
                    ...
                    <h2 className='text-2xl font-bold text-gray-700'>【仙宠口粮】</h2>
                  </div>
                  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
