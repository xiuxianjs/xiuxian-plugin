...
const ZongMeng = ({ temp }: { temp?: ZongMengItem[] }) => {
  ...
  return (
    <HTML className='w-full text-white/90 p-6 bg-center bg-cover font-serif' style={{ backgroundImage: `url(${celestialSectsURL})` }}>
      {/* 整体背景与布局 */}
                ...
                >
                  ...
                  <footer className='mt-auto p-3 bg-slate-950/50 rounded-b-xl border-t border-sky-500/20 flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-2'>
                      <img src={getAvatar(item.宗主)} alt='宗主头像' className='w-6 h-6 rounded-full border border-amber-300/50' />
