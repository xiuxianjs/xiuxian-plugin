      ...
      >
        <div className='w-full max-w-2xl mx-auto'>
          <div className='rounded-xl shadow-lg bg-white p-6 mb-6 flex flex-col items-center'>
            <div className='text-2xl font-bold text-blue-700 mb-2'>师徒商店</div>
            <div className='text-base text-gray-600 mb-1'>购买指令：#师徒兑换+物品名</div>
              ...
              {commodities_list?.map((item, index) => (
                <div key={index} className='border rounded-lg p-4 bg-gray-50 hover:bg-gray-100 transition mb-4'>
                  <div className='flex items-center justify-between mb-2'>
                    ...
                    <span className='text-sm text-green-700'>{item.积分}积分</span>
                  </div>
                  {item.class === '装备' && (
